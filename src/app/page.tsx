      ...
      <div className="mt-6 flex flex-col">
        ...
        <div className="flex items-center justify-between border-b border-zinc-200 pb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="submit"
              form="settings"
              className="rounded-lg border border-violet-600 bg-violet-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-violet-700"
            >
              Save
            </button>
          </div>
        ...
        >
          ...
          <div className="grid-cols-form grid gap-3 pt-5">
            ...
            <Input.Root>
              <Input.Prefix>
                <LuMail className="size-5 text-zinc-500" />
              </Input.Prefix>
              <Input.Control
                id="email"
                type="email"
            ...
            <div className="flex items-start gap-5">
              ...
              >
                <div className="border-6 rounded-full border-zinc-50 bg-zinc-100 p-2 group-hover:border-violet-50 group-hover:bg-violet-100">
                  <LuUploadCloud className="size-5 text-zinc-600 group-hover:text-violet-600" />
                </div>
