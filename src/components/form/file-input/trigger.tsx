...
export const Trigger = () => {
  ...
  return (
    <label
      htmlFor={id}
      className={twMerge(
        'group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm transition-colors',
    ...
    >
      ...
      >
        <LuUploadCloud className="size-5 text-zinc-600 group-hover:text-violet-600 dark:text-zinc-500 dark:group-hover:text-violet-300" />
      </div>
